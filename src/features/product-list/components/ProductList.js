...
export function ProductList() {
  ...
  const [filter, setFilter] = useState({}); //filter obj will look like {category: "xyz", brand:"abc", _sort:"",_order:""}

  const handleFliter = (e, section, option) => {
