...
import { selectCartItems,deleteFromCartAsync,updateCartAsync } from "../features/cart/cartSlice";
...
function Checkout() {
  ...
  const handleOrder = (e)=>{
    const order = {user, items, totalItems, totalPrice, paymentMethod, selectedAddress};
