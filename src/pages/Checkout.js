...
function Checkout() {
  ...
  return (
    <>
      {!items.length &&
        isCartLoaded && ( // cartLoaded is must to prevent from navigating to "/" even !items.length was true
                ...
                <div className="space-y-12">
                  ...
                  <div className="border-b border-gray-900/10 pb-12">
                    ...
                    {user && user.address.length ? (
                      ...
                      <p className="mt-4 text-sm leading-6 text-red-600 flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                        Please add your address to choose...
                      </p>
                    )}
